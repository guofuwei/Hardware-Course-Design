...
#define VS10XX_RST_GPIO_PIN             GPIO_PIN_11
#define VS10XX_RST_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */

#define VS10XX_XCS_GPIO_PORT            GPIOA
#define VS10XX_XCS_GPIO_PIN             GPIO_PIN_8
#define VS10XX_XCS_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */

#define VS10XX_XDCS_GPIO_PORT           GPIOA
#define VS10XX_XDCS_GPIO_PIN            GPIO_PIN_4
#define VS10XX_XDCS_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */

#define VS10XX_DQ_GPIO_PORT             GPIOA
#define VS10XX_DQ_GPIO_PIN              GPIO_PIN_12
#define VS10XX_DQ_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)   /* PA口时钟使能 */
